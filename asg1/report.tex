			 ...
			 \begin{enumerate}[label=(\alph*)]
				...
				\item
				 	\begin{figure}[t]
						...
						\end{subfigure}%
				 	\end{figure}
					 The code snippet for showing patch images on figure 2:
				 	\lstinputlisting{code/tsk1_1.m} 
			\end{enumerate}		
				...
				\item
					...
					\end{center}
				 	\begin{figure}[t]
				 		...
				 		\label{fig:p1-2-c}
				 	\end{figure}
					This is not a typo, surprisingly my performance is a bit better on the test set. That is why we can conclude that linear regression is not overfitting the data in this problem. It can be seen from figure \ref{fig:p1-2-c} that indeed there is strong positive correlation between closest neighbours of the target value pixel. 
			\end{enumerate}
