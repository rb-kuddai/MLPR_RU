		...
		\subsection{Data preprocessing and visualization}
			 \begin{enumerate}[label=(\alph*)]
			 	\item
				 	...
				 	The distribution can be approximated by family of distribution $P(t) \propto t^{\alpha} exp(-\beta t)$. For example, if I put $\alpha = 0.78$ and $\beta = 50$ then I will have the figure \ref{fig:p1-1-a_dist}\\
