	...
	\section{The Next Pixel Prediction Task}
		...
		\subsection{Linear regression with all pixels}
			...
			\begin{center}
				...
				\end{tabular}
			\end{center}
			There is an improvement in comparison to both previous methods but on the test set it is quite small. Overall, it is possible to conclude that whereas knowledge of all the pixels helps to predict the value of the target pixel better, indeed, the most significant features are the pixels adjacent to the target one.
